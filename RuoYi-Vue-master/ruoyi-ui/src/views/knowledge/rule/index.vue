...
<!--        <el-input-->
<!--          v-model="queryParams.generalnum"-->
<!--          placeholder="请输入通用数量"-->
<!--          clearable-->
<!--          size="small"-->
...
<!--        />-->
<!--      </el-form-item>-->
<!--      <el-form-item label="专项数量" prop="securitynum">-->
<!--        <el-input-->
...
<!--        />-->
<!--      </el-form-item>-->
<!--      <el-form-item label="安全数量" prop="specialnum">-->
<!--        <el-input-->
<!--          v-model="queryParams.specialnum"-->
<!--          placeholder="请输入安全数量"-->
<!--          clearable-->
<!--          size="small"-->
<!--          @keyup.enter.native="handleQuery"-->
...
<!--    </el-form>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px" style="width: 299px">
        ...
        <el-form-item label="专项数量" prop="securitynum">
          <el-input v-model="form.securitynum" placeholder="请输入专项数量" />
        </el-form-item>
        <el-form-item label="安全数量" prop="specialnum">
          <el-input v-model="form.specialnum" placeholder="请输入安全数量" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除发送规则编号为"' + ruleids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有发送规则数据项?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(() => {
